...
return(
    <Link ><Popup trigger={<List.Item className="fade-in" style={{ display: "inline-flex", margin: "10px 20px", textAlign: "center", border: "0.5px grey solid",  width: "220px", borderRadius: "15px", color: "black", height: "auto", justifyContent: "center" }} onClick={() => props.sendToEdit(props.ingredient)}>
        <Image src={props.ingredient.image_url} style={{ paddingLeft: "10px" }} />

        <List.Content style={{ alignSelf: "center", padding: "7px 10px", flexGrow: "1"  }} >
