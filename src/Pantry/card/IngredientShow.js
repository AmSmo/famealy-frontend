...
function IngredientShow(props) {
    ...
    return (<Link ><Popup trigger={<List.Item style={{ display: "inline-flex", margin: "20px", textAlign: "center", border: "0.5px grey solid", height: "80px", width: "220px", background: "white", borderRadius: "15px", color: "black"}} onClick={() => props.sendToEdit(props.ingredient)}>
