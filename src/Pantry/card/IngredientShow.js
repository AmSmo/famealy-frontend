...
function IngredientShow(props) {
    ...
    return (<Link ><Popup trigger={<List.Item style={{ display: "inline-flex", margin: "10px 20px", textAlign: "center", border: "0.5px #fff solid", height: "80px", width: "220px", background: "rgba(255,255,255,0.5)", borderRadius: "15px", color: "black"}} onClick={() => props.sendToEdit(props.ingredient)}>
