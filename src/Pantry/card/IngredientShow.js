...
function IngredientShow(props) {
    ...
    return (<Link ><Popup trigger={<List.Item className="fade-in" style={{ display: "inline-flex", margin: "10px 20px", textAlign: "center", border: "0.5px grey solid", height: "auto", width: "220px", background: "rgba(255,255,255,0.5)", borderRadius: "15px", color: "black", verticalAlign: "middle"}} onClick={() => props.sendToEdit(props.ingredient)}>
